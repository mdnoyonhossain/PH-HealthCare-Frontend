    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ textAlign: "center" }}>
                ...
                <Typography component="p" fontSize={18} fontWeight={400} sx={{ mt: 2 }}>Access to expert physicians and surgeons, advanced technologies</Typography>
                    ...
                    {doctors?.map((doctor: any) => (
                        <Grid item key={doctor.id} md={4}>
                            <Card>
                                ...
                                <CardActions sx={{ justifyContent: "space-evenly", px: 2, paddingBottom: "20px" }}>
